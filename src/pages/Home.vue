...
<template>
  <div class="app-wrapper">
    <header class="hero-section">
      ...
      <p class="subtitle">
        This entire page structure is pre-rendered into a static HTML file at build time. Your
        browser paints the UI instantly, and Vue silently takes control in the background.
      </p>
    </header>
      ...
      <section class="card interactive-card" :class="{ 'fully-hydrated': isHydrated }">
        ...
        <div class="interaction-controls">
          <input
            ...
            :disabled="!isHydrated"
          />
          <button @click="triggerReactivity" class="action-button" :disabled="!isHydrated">
